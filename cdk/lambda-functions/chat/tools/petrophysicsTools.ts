...
// REMOVED: Old duplicate definition of comprehensivePorosityAnalysisTool
// The real implementation with S3 storage is in comprehensivePorosityAnalysisTool.ts
// Import it below instead of defining it here
