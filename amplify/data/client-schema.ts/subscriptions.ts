...
>;
export const onCreateWell = /* GraphQL */ `subscription OnCreateWell($filter: ModelSubscriptionWellFilterInput) {
...
` as GeneratedSubscription<
  APITypes.OnCreateWellSubscriptionVariables,
  APITypes.OnCreateWellSubscription
>;
...
>;
export const onDeleteWell = /* GraphQL */ `subscription OnDeleteWell($filter: ModelSubscriptionWellFilterInput) {
...
` as GeneratedSubscription<
  APITypes.OnDeleteWellSubscriptionVariables,
  APITypes.OnDeleteWellSubscription
>;
...
>;
export const onUpdateWell = /* GraphQL */ `subscription OnUpdateWell($filter: ModelSubscriptionWellFilterInput) {
...
` as GeneratedSubscription<
  APITypes.OnUpdateWellSubscriptionVariables,
  APITypes.OnUpdateWellSubscription
>;
