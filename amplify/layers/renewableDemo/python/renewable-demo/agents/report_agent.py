...
from strands_tools import generate_image, current_time, http_request, python_repl
...
try:
    ...
    from agents.tools.report_tools import list_project_files, create_pdf_report_with_images, save_chart
    from agents.tools.shared_tools import list_project_files, load_project_data, get_latest_images
...
@tool
def report_agent(region_name="us-west-2", model_id="us.anthropic.claude-3-7-sonnet-20250219-v1:0", query="No prompt found in input, please guide customer to create a json payload with prompt key") -> str:
