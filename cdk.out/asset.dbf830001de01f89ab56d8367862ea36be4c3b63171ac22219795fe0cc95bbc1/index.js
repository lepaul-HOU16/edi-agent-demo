...
// lambda-functions/renewable-orchestrator/index.ts
var index_exports = {};
  ...
  try {
    switch (intent.type) {
      ...
      case "wake_simulation":
        ...
        console.log("\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500");
        console.log("\u{1F50D} WAKE SIMULATION - Context Diagnostic");
        console.log("\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500");
        console.log(`\u{1F4CB} Request ID: ${requestId}`);
        console.log(`\u{1F4E6} Context Keys: ${Object.keys(context || {}).join(", ")}`);
        console.log(`\u{1F4D0} Has layout: ${!!context?.layout}`);
        console.log(`\u{1F4D0} Has layout_results: ${!!context?.layout_results}`);
        console.log(`\u{1F4D0} Has layoutResults: ${!!context?.layoutResults}`);
        console.log(`\u{1F4D0} Has intent.params.layout: ${!!intent.params.layout}`);
        console.log(`\u{1F194} Project ID: ${intent.params.project_id}`);
        if (context?.layout_results) {
          console.log(`\u{1F4E6} Layout Results Type: ${typeof context.layout_results}`);
          console.log(`\u{1F4E6} Layout Results Keys: ${Object.keys(context.layout_results).join(", ")}`);
          if (context.layout_results.features) {
            console.log(`\u{1F3D7}\uFE0F  Layout has ${context.layout_results.features.length} turbine features`);
          }
        }
        console.log("\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500");
