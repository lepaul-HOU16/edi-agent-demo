...
try:
    ...
    # Load event
    with open('/Users/lepaul/Dev/prototypes/edi-agent-demo/tests/temp-event-1761063775928.json', 'r') as f:
        event = json.load(f)
    ...
    # Write result
    with open('/Users/lepaul/Dev/prototypes/edi-agent-demo/tests/temp-result-1761063775928.json', 'w') as f:
        json.dump(result, f)
