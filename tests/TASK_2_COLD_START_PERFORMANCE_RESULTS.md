...
|--------|-------|--------|--------|
| **Total Duration** | [58.35]s ([0.00] min) | < 300s (5 min) | [✅ PASS] |
...
|-------|----------|------------|-------|
| **Initialization** | [0.00]s | [XX.X]% | Docker pull, Python startup, dependency loading |
...
| Initialization Time | 1-3 minutes | [0.00] minutes | [+/- XX]% |
| Execution Time | 30-60 seconds | [32.51] seconds | [+/- XX]% |
