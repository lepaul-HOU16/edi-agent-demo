#!/usr/bin/env python3
"""
Simplified Multi-Agent System Deployment
Uses existing utilities from workshop-assets
"""
...
def main():
    ...
    try:
        ...
        print(f"⚠️  Gateway test failed (non-critical): {e}\n")
