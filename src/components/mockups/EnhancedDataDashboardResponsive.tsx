 ...
 * Optimized for narrow vertical panel in catalog page
 * - Stacked layout (no side-by-side grids)
 * - Compact spacing and typography
 * - Collapsible sections for better scrolling
 * - Single-column charts
 */
const EnhancedDataDashboardResponsive = React.memo<DataDashboardProps>(({ 
  wells, 
  queryType, 
  searchQuery,
  weatherData
...
EnhancedDataDashboardResponsive.displayName = 'EnhancedDataDashboardResponsive';

export default EnhancedDataDashboardResponsive;
