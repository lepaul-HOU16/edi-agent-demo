...
interface PlotDataToolComponentProps {
  content: Message['content'];
  theme: Theme;
  chatSessionId: string;
}

const PlotDataToolComponent: React.FC<PlotDataToolComponentProps> = ({ content, theme }) => {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <Typography variant="caption" color="textSecondary" display="block" sx={{ marginTop: 2, textAlign: 'center' }}>
        Plot data tool visualization
      </Typography>
    </Box>
  );
};

export { PlotDataToolComponent };
export default PlotDataToolComponent;
