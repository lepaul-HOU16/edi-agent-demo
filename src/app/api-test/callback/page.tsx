...
/**
 * Callback page that handles the redirect from Cognito after authentication
...
export default function CallbackPage() {
  ...
  useEffect(() => {
    console.log('API Test Callback page loaded with OIDC context');
  ...
  return (
    <Container header="Authentication in progress">
      <Box padding="l" textAlign="center">
        <SpaceBetween direction="vertical" size="l">
          <Spinner size="large" />
